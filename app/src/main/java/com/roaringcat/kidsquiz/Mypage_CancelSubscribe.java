...
public class Mypage_CancelSubscribe extends Lock_BaseActivity {
    boolean mSubKidsquiz = false;
    public TemplateView template;
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mypage_subscribe_cancel);
    }
    ...
    protected void onResume() {
        ...
        template = (TemplateView) findViewById(R.id.ad_subscribe_cancel);
